...
public class PageFetcher extends Configurable {
  ...
  public PageFetcher(CrawlConfig config) {
   ...
   // System.out.println("PageFetcher called ");;
  ...
  public synchronized void shutDown() {
	  ...
	  logger.info("stopping PageFetcher");
    ...
    if (connectionMonitorThread != null) {
      ...
      connectionMonitorThread.shutdown();
    	...
    	logger.info("connectionMonitorThread was null");
...
public  void shutDown2() {
	  ...
	  logger.info("stopping PageFetcher version 2");
	//  System.out.println("pagefetcher shutdown 2: " + connectionMonitorThread);;
    ...
    if (connectionMonitorThread != null) {
      ...
      connectionMonitorThread=null;
    	...
    	logger.info("connectionMonitorThread was null");
    //	 System.out.println("pagefetcher connectionMonitorThread was null");;
    //}
  }
