...
public class WebCrawler implements Runnable {
  ...
  */
  ...
  private void processPage(WebURL curURL) {
	...
	//  System.out.println("processpage " + curURL);;
    ...
    try {
     ...
     // System.out.println("fetchresult " + fetchResult.toString());;
      ...
      //  System.out.println("fetchresult content " + fetchResult.getEntity().getContentLength());;
